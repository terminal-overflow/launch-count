...
if os.stat("info/info.txt").st_size > 0:
    ...
    if len(r) != len(dates):
        ...
        for i in range(len(dates)):
            ...
            t_string, l_year, l_month, l_day, l_hour, l_minute, l_second = dates[
                num
            ].split(",")
            # convert str to int
            l_year = int(l_year)
            ...
            # get days till
            days_till = (
                datetime(l_year, l_month, l_day, l_hour, l_minute, l_second)
                - datetime.now()
            ).days
            if days_till < 0:
                if num + 1 == len(dates):
...
# static text
title = Label(
    root, text="World Times", width=15, height=2, foreground="white", background="black"
)
title.config(font=("Arial", f_size + 10))

# <= -1
cape_verde_txt = Label(
    root, text="Cape Verde:", width=15, height=2, foreground="white", background="black"
)
cape_verde_txt.config(font=("Arial", f_size))

south_georgia_txt = Label(
    root,
    text="South Georgia:",
    width=15,
    height=2,
...
greenland_txt = Label(
    root, text="Greenland:", width=15, height=2, foreground="white", background="black"
)
greenland_txt.config(font=("Arial", f_size))

french_guiana_txt = Label(
    root,
    text="French Guiana:",
    width=15,
    height=2,
...
new_york_txt = Label(
    root, text="New York:", width=15, height=2, foreground="white", background="black"
)
new_york_txt.config(font=("Arial", f_size))

chicago_txt = Label(
    root, text="Chicago:", width=15, height=2, foreground="white", background="black"
)
chicago_txt.config(font=("Arial", f_size))

denver_txt = Label(
    root, text="Denver:", width=15, height=2, foreground="white", background="black"
)
denver_txt.config(font=("Arial", f_size))

los_angeles_txt = Label(
    root,
    text="Los Angeles:",
    width=15,
    height=2,
...
alaska_txt = Label(
    root, text="Alaska:", width=15, height=2, foreground="white", background="black"
)
alaska_txt.config(font=("Arial", f_size))

hawaii_txt = Label(
    root, text="Hawaii:", width=15, height=2, foreground="white", background="black"
)
hawaii_txt.config(font=("Arial", f_size))

# >= 0
iceland_txt = Label(
    root, text="Iceland:", width=15, height=2, foreground="white", background="black"
)
iceland_txt.config(font=("Arial", f_size))

england_txt = Label(
    root, text="England:", width=15, height=2, foreground="white", background="black"
)
england_txt.config(font=("Arial", f_size))

france_txt = Label(
    root, text="France:", width=15, height=2, foreground="white", background="black"
)
france_txt.config(font=("Arial", f_size))

moscow_txt = Label(
    root, text="Moscow:", width=15, height=2, foreground="white", background="black"
)
moscow_txt.config(font=("Arial", f_size))

india_txt = Label(
    root, text="India:", width=15, height=2, foreground="white", background="black"
)
india_txt.config(font=("Arial", f_size))

kazakhstan_txt = Label(
    root, text="Kazakhstan:", width=15, height=2, foreground="white", background="black"
)
kazakhstan_txt.config(font=("Arial", f_size))

china_txt = Label(
    root, text="China:", width=15, height=2, foreground="white", background="black"
)
china_txt.config(font=("Arial", f_size))

japan_txt = Label(
    root, text="Japan:", width=15, height=2, foreground="white", background="black"
)
japan_txt.config(font=("Arial", f_size))

australia_txt = Label(
    root, text="Australia:", width=15, height=2, foreground="white", background="black"
)
australia_txt.config(font=("Arial", f_size))

new_zealand_txt = Label(
    root,
    text="New Zealand:",
    width=15,
    height=2,
...
# live time
# <= -1
cape_verde_label = Label(
    root,
    text=datetime_utc_1.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
south_georgia_label = Label(
    root,
    text=datetime_utc_2.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
greenland_label = Label(
    root,
    text=datetime_utc_3.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
french_guiana_label = Label(
    root,
    text=datetime_utc_4.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
new_york_label = Label(
    root,
    text=datetime_utc_5.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
chicago_label = Label(
    root,
    text=datetime_utc_6.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
denver_label = Label(
    root,
    text=datetime_utc_7.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
los_angeles_label = Label(
    root,
    text=datetime_utc_8.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
alaska_label = Label(
    root,
    text=datetime_utc_9.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
hawaii_label = Label(
    root,
    text=datetime_utc_10.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
iceland_label = Label(
    root,
    text=datetime_utc0_2.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
england_label = Label(
    root,
    text=datetime_utc0.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
france_label = Label(
    root,
    text=datetime_utc1.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
moscow_label = Label(
    root,
    text=datetime_utc3.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
india_label = Label(
    root,
    text=datetime_utc55.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
kazakhstan_label = Label(
    root,
    text=datetime_utc6.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
china_label = Label(
    root,
    text=datetime_utc8.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
japan_label = Label(
    root,
    text=datetime_utc9.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
australia_label = Label(
    root,
    text=datetime_utc11.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
new_zealand_label = Label(
    root,
    text=datetime_utc12.strftime("%d:%m:%Y %H:%M:%S %Z %z"),
    width=28,
    height=2,
    foreground="green",
    background="black",
...
def main_loop():
    ...
    title.config(font=("Arial", f_size + 10))
    cape_verde_txt.config(font=("Arial", f_size))
    cape_verde_label.config(
        text=datetime_utc_1.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    south_georgia_txt.config(font=("Arial", f_size))
    south_georgia_label.config(
        text=datetime_utc_2.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    greenland_txt.config(font=("Arial", f_size))
    greenland_label.config(
        text=datetime_utc_3.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    french_guiana_txt.config(font=("Arial", f_size))
    french_guiana_label.config(
        text=datetime_utc_4.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    new_york_txt.config(font=("Arial", f_size))
    new_york_label.config(
        text=datetime_utc_5.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    chicago_txt.config(font=("Arial", f_size))
    chicago_label.config(
        text=datetime_utc_6.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    denver_txt.config(font=("Arial", f_size))
    denver_label.config(
        text=datetime_utc_7.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    los_angeles_txt.config(font=("Arial", f_size))
    los_angeles_label.config(
        text=datetime_utc_8.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    alaska_txt.config(font=("Arial", f_size))
    alaska_label.config(
        text=datetime_utc_9.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    hawaii_txt.config(font=("Arial", f_size))
    hawaii_label.config(
        text=datetime_utc_10.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )

    # >= 0
    iceland_txt.config(font=("Arial", f_size))
    iceland_label.config(
        text=datetime_utc0_2.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    england_txt.config(font=("Arial", f_size))
    england_label.config(
        text=datetime_utc0.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    france_txt.config(font=("Arial", f_size))
    france_label.config(
        text=datetime_utc1.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    moscow_txt.config(font=("Arial", f_size))
    moscow_label.config(
        text=datetime_utc3.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    india_txt.config(font=("Arial", f_size))
    india_label.config(
        text=datetime_utc55.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    kazakhstan_txt.config(font=("Arial", f_size))
    kazakhstan_label.config(
        text=datetime_utc6.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    china_txt.config(font=("Arial", f_size))
    china_label.config(
        text=datetime_utc8.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    japan_txt.config(font=("Arial", f_size))
    japan_label.config(
        text=datetime_utc9.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    australia_txt.config(font=("Arial", f_size))
    australia_label.config(
        text=datetime_utc11.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    new_zealand_txt.config(font=("Arial", f_size))
    new_zealand_label.config(
        text=datetime_utc12.strftime("%d:%m:%Y %H:%M:%S %Z %z"), font=("Arial", f_size)
    )
    ...
    if days_till != "hidden":
        ...
        if days_till >= 0:
            ...
            end = datetime(l_year, l_month, l_day, l_hour, l_minute, l_second).strftime(
                "%H:%M:%S"
            )
            total_time = datetime.strptime(end, "%H:%M:%S") - datetime.strptime(
                start, "%H:%M:%S"
            )
